    ...
    <Disclosure as="div" className="grid w-full gap-2 border-[#595959]  border-t">
      {({open}) => (
        <>
          ...
          >
            <Disclosure.Panel
              className="editor-content px-[20px] pb-[40px] lg:pb-[50px] pt-0 tracking-[-0.400697px] text-[16px] md:text-[18px] lg:text-[20px] xl:text-[21px] font-normal leading-[1.4] flex flex-col-reverse lg:flex-row gap-y-[20px] 2xl:gap-x-[120px] xl:gap-x-[80px] lg:gap-x-[50px]"
              static
            >
