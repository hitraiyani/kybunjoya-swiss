...
export function NotFound({type = 'page', locale}) {
          ...
          <div className="relative flex w-full image-container pb-[100%] md:pb-[65%] lg:pb-[55%] xl:pb-[45%] 2xl:pb-[38.5%] overflow-hidden">
            ...
            <div className="absolute slider-content bottom-[15px] md:bottom-[33px] left-0 right-0 w-full px-[15px] md:px-[33px] lg:px-[46px] max-w-[702px]">
              <h2 className="text-white title text-[35px] lg:text-[40px] xl:text-[50px] tracking-[-1.05984px] font-bold">
                {translate('Seite nicht gefunden', locale?.language)}
              </h2>
              <div className="desc text-white text-[16px] lg:text-[21px] tracking-[-0.400697px] leading-[1.3] font-[400] max-w-[930px] mt-[10px] xl:mt-[28px]">
                <p>
                  {translate(
                    'Wir konnten die von Ihnen gesuchte Seite nicht finden.Überprüfen Sie die URL oder kehren Sie zur Startseite zurück.',
                    locale?.language,
                  )}
                </p>
              </div>
              <div className="btn-wrap mt-[15px] xl:mt-[28px]">
                ...
                >
                  {translate('Heim', locale?.language)}
                </a>
              </div>
            </div>
          </div>
